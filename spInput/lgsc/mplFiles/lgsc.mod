...
set DC2R_LINKS within {K_DC, R} ;  # set of transportation links between distribution centers and customers
set P2R_LINKS within {K_P, R} ; # set of transportation links between plants and customers
...
# unmet demand of product j in customer r at time period t
...
minimize totalCost:
   ...
   + sum {k in K_DC, r in R, j in J, m in M, t in T: t = 1 and (k, r) in DC2R_LINKS} delta[k, j, t] * S[k, r, j, m, t]
   ...
   + sum{k in K_DC, r in R, j in J, m in M, t in 2..n : (k, r) in DC2R_LINKS} delta[k, j, t] * S[k, r, j, m, t] + sum {r in R, j in J, t in T} eta[r, j, t] * SF[r, j, t] ;
...
# First stage mass balance for customers (The connecting constraints First and Second stage)
subject to massBalanceC1 {r in R, j in J, t in T: t = 1}:
...
subject to massBalanceP2 {j in J, k1 in K_P, t in 2..n} :
   sum {k2 in K, m in M : (k1, k2) in P2DC_LINKS} F [k1, k2, j, m, t] + sum {r in R, m in M : (k1, r) in PDC2R_LINKS} S [k1, r, j , m, t] = I [k1, j, t-1] - I [k1, j, t] + W [k1, j, t] + sum {k2 in K, m in M : (k2, k1) in P2DC_LINKS and t > lambdaK[k2, k1, j, m]} F [k2, k1, j, m, t - lambdaK[k2, k1, j, m]];

# Second stage mass balance for distribution centers
subject to massBalanceDC2 {j in J, k1 in K_DC, t in 2..n} :
   sum {k2 in K, m in M : (k1, k2) in P2DC_LINKS} F [k1, k2, j, m, t] + sum {r in R, m in M : (k1, r) in DC2R_LINKS} S [k1, r, j, m, t] = I [k1, j, t-1] - I [k1, j, t] + sum {k2 in K, m in M : (k2, k1) in P2DC_LINKS and t > lambdaK[k2, k1, j, m]} F [k2, k1, j, m, t - lambdaK[k2, k1, j, m]];

# Second stage mass balance for customers (The connecting constraints First and Second stage)
subject to massBalanceC2 {r in R, j in J, t in 2..n}:
   sum {k in K, m in M : (k, r) in PDC2R_LINKS and t > lambdaR[k, r, j, m]} S [k, r, j, m, t - lambdaR[k, r, j, m]] + SF[r, j, t] = d[r, j, t] ;
